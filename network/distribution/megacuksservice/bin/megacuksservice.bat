@REM megacuksservice launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM MEGACUKSSERVICE_config.txt found in the MEGACUKSSERVICE_HOME.
...
if "%MEGACUKSSERVICE_HOME%"=="" (
  set "APP_HOME=%~dp0\\.."

  rem Also set the old env name for backwards compatibility
  set "MEGACUKSSERVICE_HOME=%~dp0\\.."
) else (
  set "APP_HOME=%MEGACUKSSERVICE_HOME%"
)
...
set "CFG_FILE=%APP_HOME%\MEGACUKSSERVICE_config.txt"
set CFG_OPTS=
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running megacuksservice.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !MEGACUKSSERVICE_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
