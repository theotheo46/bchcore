 ...
 */
object TransferLockedAfter extends TransferGene
    ...
    def canTransfer(context: GeneExecutionContext, leg: DealLeg, deal: DealRequest): Result[Boolean] = lockUpPassed(context).map(!_)
