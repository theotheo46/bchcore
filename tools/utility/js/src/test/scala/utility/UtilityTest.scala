 ...
 */
class UtilityTest extends AnyFreeSpec {
    ...
    "proxying" - {
        ...
        "works as expected Int input and Int output" in {
            ...
            expectedSumResult.map(value => assert(value == 5))
            ...
            expectedSubtractResult.map(value => assert(value == 5))
        ...
        "works as expected Short input and Short output" in {
            ...
            expectedSumResult.map(value => assert(value == 5.toShort))
            ...
            expectedSubtractResult.map(value => assert(value == 5.toShort))
        ...
        "works as expected Long input and Long output" in {
            ...
            expectedSubtractResult.map(value => assert(value == 1))
        }
        ...
        "works as expected String input and String Output" in {
            ...
            expectedGreetingsResult.map(value => assert(value == "Greetings, John Doe!"))
        }
        ...
        "works as expected String input and Object Output" in {
            ...
            expectedPutResult.map(value => assert(value == person))
        }
        ...
        "works as expected String input and Option Object Output" in {
            ...
            expectedGetOptionResult.map(value => assert(value == Option(person)))
        }
        ...
        "works as expected no input and List Object Output" in {
            ...
            expectedListPersonResult.map(value => assert(value sameElements personArray))
        }
        ...
        "works as expected Object input and String Output" in {
            ...
            expectedPutResult.map(value => assert(value == "Success"))
        }
        ...
        "works as expected Boolean input and Boolean Output" in {
            ...
            expectedTestBooleanResult.map(value_ => assert(value_ == value))
        }
    }
